...
def get_directory_npcs(directory: str = None) -> List[str]:
    """
    Function Description:
        This function retrieves a list of valid Guardians from the database.
    Args:
        db_path: The path to the database file.
    Keyword Args:
        None
    Returns:
        A list of valid Guardians.
    """
...
def init_db_tables(db_path="~/npcsh_history.db"):
    ...
    with sqlite3.connect(db_path) as conn:
        # Guardian log table for storing all kinds of entries
        conn.execute("""
        ...
        # Compiled Guardians table for storing compiled Guardian content
        conn.execute("""
...
def get_system_message(npc) -> str:
    """
    Function Description:
        This function generates a system message for the Guardian.
    Args:
        npc (Any): The Guardian object.
    Keyword Args:
        None
    Returns:
        str: The system message for the Guardian.
    """
    ...
    Hello!
    Welcome to the team.
    You are an Guardian working as part of our team.
    You are the {npc.name} Guardian with the following primary directive: {npc.primary_directive}.
