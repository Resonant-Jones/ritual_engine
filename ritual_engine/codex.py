...
from ritual_engine.gen.response import get_litellm_response
from ritual_engine.gen.image_gen import generate_image, edit_image
from ritual_engine.gen.video_gen import generate_video_diffusers
...
def get_llm_response(
    ...
    **kwargs,
    ...
    """
    # Determine provider and model from Guardian if needed
    if model is not None and provider is not None:
        pass
...
def execute_llm_command(
    ...
    Keyword Args:
        ...
        npc (Optional[Any]): The Guardian object.
...
def handle_jinx_call(
    ...
    if npc is None:
        ...
        if jinx_name not in npc.jinxs_dict:
            print("not available")
            print(f"jinx '{jinx_name}' not found in Guardian's jinxs_dict.")
...
def check_llm_command(
    ...
    if npc is not None:
        ...
        if npc.jinxs_dict is None :
            jinx_component += "No Guardian jinxs available. Do not invoke jinxs."
        else:
    ...
    if team is None:
        prompt += "No Guardians available for alternative answers."
    else:
        ...
        #else:
        #    prompt += f"""
        #    Available Guardians for alternative answers:#
        #
        #        {team.npcs}
        #    """
        if team.context:
