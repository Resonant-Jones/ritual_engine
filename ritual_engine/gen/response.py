...
from ritual_engine.data.image import compress_image
from ritual_engine.npc_sysenv import get_system_message, lookup_provider, render_markdown
import base64
import json
import uuid
import os 
        ...
        for attachment in attachments:
            if os.path.exists(attachment):
                ...
                if ext in ['.jpg', '.jpeg', '.png', '.gif', '.bmp']:
                    ...
                    try:
                        from ritual_engine.data.load import load_pdf
                    ...
                    try:
                        from ritual_engine.data.load import load_csv
...
def get_litellm_response(
    ...
    **kwargs,
    ...
    if model is None:
        model = os.environ.get("GuardianSH_CHAT_MODEL", "llama3.2")
    if provider is None:
        provider = os.environ.get("GuardianSH_CHAT_PROVIDER", "openai")
