...
def assign_fact_to_dag(fact: str, dag_data: Dict, model: str, provider: str, npc: Guardian = None) -> Dict:
...
def test_hierarchical_knowledge_graph():
    ...
    It supports creating custom Guardians with specific personalities and directives.
...
def process_text_with_chroma(
    ...
    Args:
        ...
        npc: Optional Guardian instance
    ...
    for i in range(0, len(facts), batch_size):
        ...
        # Generate embeddings for the batch using ritual_engine.llm_funcs.get_embeddings
        from ritual_engine.llm_funcs import get_embeddings
...
def hybrid_search_with_chroma(
    ...
    """
    # Get embedding for query using ritual_engine.llm_funcs.get_embeddings
    from ritual_engine.llm_funcs import get_embeddings
...
class KnowledgeGraphManager:
    def __init__(self, db_path: str, model: str, provider: str, npc: Optional[Guardian] = None):
