"""
Sleep module for Guardian agents.

This module provides functions for the "sleep" process of Guardian agents, which includes:
...
def sleep(conversation_history: List[Dict], 
    ...
    """
    Main sleep function for Guardian agents. This processes conversation history,
...
def forget(query: str, 
    ...
    try:
        ...
        try:
            from ritual_engine.memory.knowledge_graph import remove_from_vector_db
