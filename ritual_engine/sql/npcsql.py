...
from ritual_engine.npc_compiler import 
...
class GuardianDBTAdapter:
    def __init__(self, npc_sql: GuardianSQLOperations):
...
class SQLModel:
    def __init__(self, name: str, content: str, path: str, npc_directory: str):
        ...
        print(f"Initializing SQLModel with Guardian directory: {npc_directory}")
...
class ModelCompiler:
    def __init__(self, models_dir: str, db_path: str, npc_directory: str):
        ...
        self.npc_operations = GuardianSQLOperations(npc_directory, db_path)
